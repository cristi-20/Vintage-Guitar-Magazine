    ...
    var drawTable = function () {
      ...
      $.each(products, function () {
        ...
        $cartTable.append(
          ...
          '<td class="text-center" style="width: 30px;"><img width="40px" height="40px" src="' + this.image + '"/></td>' +
          '<td>' + this.name + '</td>' +
          ...
          '<td title="Remove from Cart" class="text-center" style="width: 30px;"><a href="javascript:void(0);" class="btn btn-xs ' + classProductRemove + '">X</a></td>' +
          '</tr>'
        );
      });
